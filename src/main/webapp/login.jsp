...
<body>
   <script async defer crossorigin="anonymous"
      src="https://connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v13.0&appId=462816965629984&autoLogAppEvents=1"
...
<br>
      ...
      <br><br>
         <form id="login" action="login.do" class="input-group">
            ...
            <div style="text-align: center">
               ...
               <a href="findPw.jsp" class="findPw">비밀번호찾기</a>
      ...
      <!-- 페이스북 스크립트 -->
      <script async defer crossorigin="anonymous"
         src="https://connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v10.0&appId=462816965629984"
      ...
      <script>
      //============카카오 로그인=================
         Kakao.init('09bf4131ade021cfc3419a6d4a947978'); //발급받은 키 중 javascript키를 사용해준다.
         ...
         var naverLogin = new naver.LoginWithNaverId(
               {
                  clientId : "XI_tsaj8eb8bUsBCPmvO", //내 애플리케이션 정보에 cliendId를 입력해줍니다.
                  callbackUrl : "http://localhost:9090/TP_THISPLUS/login.jsp", // 내 애플리케이션 API설정의 Callback URL 을 입력해줍니다.
                  isPopup : false,
                  callbackHandle : true
               });
         ...
         window.fbAsyncInit = function() {
            FB.init({
               appId : '462816965629984', // 내 앱 ID를 입력한다.
               cookie : true,
               xfbml : true,
               version : 'v10.0'
            });
