...
insert into member (memId,memPw,memName,memEmail,memAddress,memPic)
 values ('muscleboy','1111','김꺽정','muscle@naver.com','서울시 관악구','/img/testmonial/profile03.png');
 insert into member (memId,memPw,memName,memEmail,memAddress,memPic)
 ...
 insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
 values ('junroh','qwer1234!','노준','junroh@naver.com','경기도 용인시 기흥수','/img/testmonial/profile03.png',2);
  insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
 values ('tmdgus','qwer1234!','심승현','tmdgus@naver.com','서울시 관악구','/img/testmonial/profile01.png',1);
  insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
 values ('tlswjd','qwer1234!','김신정','muscle@naver.com','서울시 관악구','/img/testmonial/profile02.png',0);
  insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
 values ('gustn','qwer1234!','정현수','gustn@naver.com','서울시 관악구','/img/testmonial/profile07.png',0);
  insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
 values ('ekdns','qwer1234!','정다운','ekdns@naver.com','서울시 관악구','/img/testmonial/profile06.png',0);
   insert into member (memId,memPw,memName,memEmail,memAddress,memPic,memRank)
